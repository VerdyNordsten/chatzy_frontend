...
export default function Home() {
  ...
  return (
    <div className="container-fluid">
      <div className="row">
        {tab === "profile" ? <Profile /> : <ListUser setTab={setTab} selectReceiver={selectReceiver} />}
        <Chat detailReceiver={detailReceiver} activeReceiver={activeReceiver} listChat={listChat} message={message} setMessage={setMessage} onSendMessage={onSendMessage} onDeleteMessage={onDeleteMessage} onEditMessage={onEditMessage} />
      </div>
    </div>
  )
}
