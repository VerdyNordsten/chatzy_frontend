  ...
  return (
    <div className="left-menu col-4 col-md-3 p-4">
      <div className="d-block d-lg-flex justify-content-between">
        <h3 className="color-blue fw-bold">Chatzy</h3>
        <div className="dropdown">
          ...
          <ul className="dropdown-menu mt-2" aria-labelledby="dropdownMenuLink">
            ...
            <li>
              <button type="button" className="dropdown-item my-3 text-white" onClick={logout}>
                <div className="d-flex">
                  <h5>
                    <MdLogout />
                  </h5>
      ...
      <form onSubmit={submitSearch}>
        <div className="d-flex mt-4 align-items-center">
          ...
          <input type="text" className="input-search form-control" placeholder="Search for any user" value={search} onChange={(e) => setSearch(e.target.value)} />
        </div>
      </form>
      <div className="mt-4">
        {listUser.isLoading ? (
                          ...
                          <button onClick={() => selectReceiver(user.id)} type="button" className="btn text-dark w-100 mb-1">
                            <div className="user-item">
                              <div className="row w-100">
                                <div className="col-6 col-md-5 col-lg-3">{user.photo ? <img className="profile-rounded" src={`${user.photo}`} alt="Gambar Profile" /> : <img className="profile-rounded" src="https://images227.netlify.app/mernuas/default.jpg" alt="Gambar Profile" />}</div>
